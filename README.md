...
This repository contains a web-based application for the topological visualization and comparative analysis of multilayer brain networks. The platform implements the MuLaN (Multilayer Network Alignment) algorithm to compare functional connectivity between different groups (e.g., healthy controls vs. depressed patients) across multiple layers.
